  ...
  const COLUMNAS_TAREAS = [
      ...
      render: (_, tarea) => {
        ...
        return (
          <div className="flex flex-col">
            <span className="font-bold text-sm" style={{ color: "var(--table-row-text)" }}>{nombreActividad}</span>
            <span className="text-xs mt-0.5" style={{ color: "var(--card-subtitle)" }}>{nombreCategoria}</span>
          </div>
        );
      },
    },
    {
      ...
      render: (_, tarea) => {
        ...
        if (!empleado) {
          return <span className="text-sm font-medium italic" style={{ color: "var(--card-subtitle)" }}>Sin asignar</span>;
        }

        return (
          <span className="font-semibold text-sm" style={{ color: "var(--table-row-text)" }}>{empleado.nombre} {empleado.apellido}</span>
        );
      },
    },
    {
