...
export const Card = ({
    ...
    return (
        <div 
            className={`backdrop-blur-xl transition-all duration-300 ${hoverable ? 'hover:-translate-y-1' : ''} ${className}`}
            style={{
        ...
        >
            ...
            {(title || subtitle || icon || headerAction) && (
                <div className="flex items-center justify-between p-5" style={{ borderBottom: '1px solid var(--card-divider)' }}>
