import ProyectoUsuarioService from './proyecto_usuario.service.js';
...
export const obtenerUsuariosDelProyecto = async(req, res) =>{
    try{
        ...
        } = proyecto_usuarioIdValidation.validate(req.params);
        ...
        const [usuarios, err] = await ProyectoUsuarioService.obtenerUsuariosDelProyecto(
            idValue.idProyecto, 
            value);
...
export const asignarUsuarioAProyecto = async(req, res) =>{
    try{
        ...
        const [asignacion, err] = await ProyectoUsuarioService.asignarUsuarioAProyecto(
            idValue.idProyecto, 
            value,
            req.user);
...
export const desvincularUsuarioDeProyecto = async(req, res) =>{
    try {
        ...
        const [resultado, err] = await ProyectoUsuarioService.desvincularUsuarioDeProyecto(
            value.idProyecto,
            value.idUsuario,
            req.user);
