...
// ################# RUTAS DE LECTURA #################
router.get('/', ItemsCtrl.listarItems);                      // Obtener todos
router.get('/activos', ItemsCtrl.listarItemsActivos);        // Obtener activos
router.get('/tipo/:id_tipo', ItemsCtrl.listarItemsPorTipo);  // Filtrar por tipo
router.get('/:id', ItemsCtrl.getItem);                       // Obtener por ID

// ################# RUTAS DE ESCRITURA #################
router.post('/', ItemsCtrl.createItem);                      // Crear item + registro inventario
