import { AppDataSource } from '../config/configBd.js'; //hay que crear esa carpeta, es lo que hace la conexion a la base de datos
import { ILike } from "typeorm"; // Para búsquedas dinámicas
